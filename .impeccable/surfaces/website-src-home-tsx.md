---
version: 1
slug: "website-src-home-tsx"
primary_target: "website/src/home.tsx"
related_targets: ["website/src/styles.css","website/src/dithered-field.tsx","website/src/dialkit-authoring.tsx","website/index.html"]
---

# Garden landing page

- Scope: public landing page at `/`; visitor mode is Persuade.
- Audience: developers evaluating how to run an Eve agent locally.
- Job: understand Eve by Vercel versus Garden’s compatible Go implementation, verify that the boundary is honest, then install or inspect the source.
...
- Motion: honor `prefers-reduced-motion` automatically. Show a local play/pause control on each dithered video only when reduced motion is active; never use a global navigation control.
